...
class HealthNewsAdapter(val dataHealthNews: List<ItemDataRead>, val clicked:onClickItem ): RecyclerView.Adapter<HealthNewsAdapter.HealthNewsHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HealthNewsHolder {
        return HealthNewsHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_news,parent,false))
    }
